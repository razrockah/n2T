...
def model_func(breeder_mat):
    ...
    materials = openmc.Materials([breeder_mat, eurofer_he, tungsten])
    ...
    breeder_cell = openmc.Cell(name='breeder cell', region=-outer_box & +breeder_min, fill=breeder_mat)
    ...
    return lithium_model.export_to_model_xml()
